-- phpMyAdmin SQL Dump
-- version 5.1.4deb2+jammy1
-- https://www.phpmyadmin.net/
--
-- Hôte : localhost:3306
-- Généré le : mer. 08 fév. 2023 à 11:10
...
--
-- Base de données : `manitou`
--
CREATE DATABASE IF NOT EXISTS `manitou` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `manitou`;
...
CREATE TABLE `Chariot` (
  `ID` int NOT NULL,
  `annee` int NOT NULL,
  `est_operationnel` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `Statistiques` (
  ...
  `heure` int NOT NULL,
  `date` int NOT NULL,
  `temperature_moteur` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
--
...
('administrateur', '[{\"db\":\"manitou\",\"table\":\"Alarmes\"},{\"db\":\"manitou\",\"table\":\"Statistiques\"},{\"db\":\"manitou\",\"table\":\"Donnees_Vehicule\"},{\"db\":\"manitou\",\"table\":\"Chariot\"}]');
...
('administrateur', '2023-02-08 10:10:20', '{\"lang\":\"fr\",\"Console\\/Mode\":\"collapse\"}');
