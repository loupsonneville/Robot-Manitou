...
export WIN32_AS_PROJECT_PATH := "E:\Gros projet\ManitouIHM_AS111"
export WIN32_AS_SYSTEM_PATH := "D:\Automation_Studio\AS\System"
export WIN32_AS_VC_PATH := "D:\Automation_Studio\AS49\AS\VC"
export WIN32_AS_TEMP_PATH := "E:\Gros projet\ManitouIHM_AS111\Temp"
export WIN32_AS_BINARIES_PATH := "E:\Gros projet\ManitouIHM_AS111\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/4.9/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/ManitouIHM_AS111.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'Build'   
